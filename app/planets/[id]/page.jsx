...
export default function PlanetsInfo({params}){
...
return(
  ...
  {errorMessage ? (
    ...
    <div className='space'>
        ...
        <h1>{info.name}</h1>
        <Image src={`https://starwars-visualguide.com/assets/img/planets/${params.id}.jpg`} width={200} height={300} alt={info.name}/>
